#!/usr/bin/env python3
"""
Biscuit Ultra Flash Utility - Customer-facing firmware flasher
...
# Configuration
MANIFEST_URL = "https://firmware.biscuitshop.us/Biscuit_Ultra/Prod/manifest.json"
FIRMWARE_BASE_URL = "https://firmware.biscuitshop.us/Biscuit_Ultra/Prod/"
CACHE_DIR = Path(tempfile.gettempdir()) / "biscuit_firmware" / "ultra"
...
def print_banner():
    ...
    print("=" * 60)
    print("    Biscuit Ultra Flash Utility")
...
def prompt_no_devices():
    ...
    print()
    print("      Please ensure your Biscuit Ultra devices are connected via USB.")
...
def main():
    ...
    while True:
        ...
        print("[4/5] Scanning for Biscuit Ultra devices...")
        devices = scan_for_devices()

        found_any = devices["c5"] or devices["wroom"]

        if not found_any:
            print("\n      No Biscuit Ultra devices detected!")
    ...
    if c5_status is True and wroom_status is True:
        print("    Flash complete! Your Biscuit Ultra is ready.")
