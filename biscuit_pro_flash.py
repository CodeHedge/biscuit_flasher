#!/usr/bin/env python3
"""
Biscuit Pro Flash Utility - Customer-facing firmware flasher
...
CACHE_DIR = Path(tempfile.gettempdir()) / "biscuit_firmware" / "pro"
...
def print_banner():
    ...
    print("=" * 60)
    print("    Biscuit Pro Flash Utility")
...
def prompt_no_devices():
    ...
    print()
    print("      Please ensure your Biscuit Pro devices are connected via USB.")
...
def main():
    ...
    while True:
        ...
        print("[4/5] Scanning for Biscuit Pro devices...")
        devices = scan_for_devices()

        found_any = devices["c5"] or devices["wroom"]

        if not found_any:
            print("\n      No Biscuit Pro devices detected!")
    ...
    if c5_status is True and wroom_status is True:
        print("    Flash complete! Your Biscuit Pro is ready.")
